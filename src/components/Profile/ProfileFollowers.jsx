...
function ProfileFollowers() {
  ...
  const mesTweets = dataValue
    ...
    .map((tweet, index) => (
      ...
      <div
        key={index}
        className="flex justify-start items-start gap-[20px] py-6 px-4 border-solid border-b-[1px] border-b-gray-700 "
      >
        <Link
          to={`/profil/${oneUser.autorDetails}`}
        ...
        <div className="flex flex-col items-start justify-start gap-[30px] w-full  ">
          <div className="flex flex-col ">
            ...
            >
              <h4>
                <span
                  className="text-base text no-underline text-white"
                  href="#"
                >
                  {oneUser.author}
                </span>
              ...
              <img
                src={oneUser.isCertified ? oneUser.isCertified : null}
                alt=""
              />
              <p>
                <span className="text-gray-600 no-underline" href="#">
                  {oneUser.autorDetails}
                  {tweet.times}
                </span>
              </p>
            </Link>
